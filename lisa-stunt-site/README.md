...
## Hero video
The hero background is a silent, looping ~13s clip (`assets/hero.mp4`, 720p H.264) cut from your reel. It autoplays muted on load; the beach-jump photo (`assets/hero.jpg`) is the poster/fallback shown while it loads or if a browser blocks autoplay. To swap the clip later, replace `assets/hero.mp4` (keep it muted, MP4/H.264, and ideally under ~5 MB).
